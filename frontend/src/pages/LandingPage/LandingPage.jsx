  ...
  return (
    <section className="relative overflow-hidden bg-[#F1EAFE]">
      ...
      <div className="absolute inset-0">
        ...
        <svg
          className="absolute inset-0 opacity-40 w-[24px] h-[24px]"
          aria-hidden="true"
          strokeWidth="2"
        >
          <defs>
      ...
      <div className="relative max-w-7xl pt-20 md:pt-12 lg:pt-12 mr-auto ml-auto pr-6 pl-6">
        ...
        <div className="md:mt-6 text-center mt-5">
          <h1 className="max-w-3xl md:max-w-4xl md:text-5xl lg:text-6xl text-4xl font-semibold text-slate-900 tracking-tight mr-auto ml-auto">
            ...
            <span className="block mt-2">
              ...
              <span className="ml-4 relative inline-block">
                ...
                >
                  <path
                    d="M2 10 C40 2, 80 14, 120 6 S 180 8, 198 6"
                    fill="none"
          ...
          <div className="mt-8">
            <Link
              to="/templates"
              className="inline-flex items-center gap-2 hover:bg-violet-500 transition font-medium text-white bg-violet-600 rounded-md pt-3.5 pr-6 pb-3.5 pl-6 shadow-sm"
            >
              Start now
              <svg
                ...
                <div className="sm:p-8 pt-6 lg:pr-8 pb-6 pl-6">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                    <div>
                      ...
                      <ul className="text-slate-700 mt-3 space-y-2">
                        ...
                        <li className="flex gap-3 pt-1 items-center">
                          <a
                            href="#"
                            className="inline-flex p-1.5 rounded-md transition bg-slate-100 hover:bg-slate-200"
                          >
                    ...
                    <div>
                      ...
                      <p
                        className="leading-relaxed text-slate-700 text-left mt-3"
                        style={{
                          // textAlign: 'justify',
                      ...
                      >
                        Human-centered designer with a passion for accessible,
                        elegant interfaces. I turn research into scalable
                        systems.
                      </p>
                    </div>
                  </div>
                    ...
                    <div className="mt-3 space-y-3">
                      <div className="flex border-slate-200/70 border-b pb-3 items-start justify-between">
                        <div>
                          <p className="font-medium text-slate-800">
                            Senior Product Designer — Nova
                          </p>
                          <p className="text-sm text-slate-600">
                            Led design for growth platform across web & mobile.
                          </p>
                        </div>
                      ...
                      <div className="flex items-start justify-between border-b pb-3 border-slate-200/70">
                        <div>
                          ...
                          <p className="text-sm text-slate-600">
                            Built component libraries and design tokens.
                          </p>
                        </div>
                        <span className="text-sm text-slate-600">
                          2019–2022
        ...
        <div className="md:mt-12 grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-6 place-items-center mt-10">
          ...
          <span className="text-slate-500 font-medium tracking-tight">
            <img
              src="https://upload.wikimedia.org/wikipedia/commons/thumb/9/93/Facebook_logo_%282023%29.svg/2560px-Facebook_logo_%282023%29.svg.png?w=800&q=80"
              alt="Facebook logo"
          ...
          <span className="text-slate-500 font-medium tracking-tight">
            <img
              src="https://upload.wikimedia.org/wikipedia/commons/thumb/9/96/Microsoft_logo_%282012%29.svg/1280px-Microsoft_logo_%282012%29.svg.png?w=800&q=80"
              alt="Microsoft logo"
              className="h-6 md:h-7 w-auto object-cover"
              loading="lazy"
              style={{ filter: "grayscale(100%)", opacity: 0.7 }}
